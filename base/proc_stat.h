#ifndef _BASE_PROC_STAT_H
#define _BASE_PROC_STAT_H

#include <unistd.h>

namespace base 
{
	//include system cpu and memory information
	struct sys_cpu_time
	{
	...
	bool get_process_usage(pid_t id,float& cpu,float& mem,unsigned long long* uptime=NULL);	
}
